...
public class ExaminationPages extends GlobalVariable {
	...
	By sisnewnamediv = By.xpath("//div[contains(@id,'assessmenteventgrid')]//table[contains(@class,'focused-first')]//tr/td[3] | //div[text() = '"+GlobalVariable.AssessmentEvent+"']/ancestor::tr/td[3]/div");
	By sisweightagediv = By.xpath("//div[contains(@id,'assessmenteventgrid')]//table[contains(@class,'focused-first')]//tr/td[4]| //div[text() = '"+GlobalVariable.AssessmentEvent+"']/ancestor::tr/td[4]/div");
	By sisminmarksdiv = By.xpath("//div[contains(@id,'assessmenteventgrid')]//table[contains(@class,'focused-first')]//tr/td[5] | //div[text() = '"+GlobalVariable.AssessmentEvent+"']/ancestor::tr/td[5]/div");
	By sismaxmarksdiv = By.xpath("//div[contains(@id,'assessmenteventgrid')]//table[contains(@class,'focused-first')]//tr/td[6] | //div[text() = '"+GlobalVariable.AssessmentEvent+"']/ancestor::tr/td[6]/div");
	By sisstatusdiv = By.xpath("//div[contains(@id,'assessmenteventgrid')]//table[contains(@class,'focused-first')]//tr/td[7]/div | //div[text() = '"+GlobalVariable.AssessmentEvent+"']/ancestor::tr/td[7]/div");
	By sispendingstuenrldiv = By.xpath("//div[text() = '"+GlobalVariable.AssessmentEvent+"']/ancestor::tr/td[8]/div/a | //div[contains(@id,'assessmenteventgrid')]//table[contains(@class,'row-lines')]//tr/td[8]/div/a");
	By sisenrolstutab = By.xpath("//div[contains(@id,'assessmenteventgrid')]//table[contains(@class,'focused-first')]//tr/td[8]/div/a[text()='1'] | //div[text() = '"+GlobalVariable.AssessmentEvent+"']/ancestor::tr/td[8]/div/a[text()='1']");
	By siselgbletxtbox = By.xpath("//div[contains(@id,'eligiblestudentgrid')]//table[contains(@class,'row-lines')]//tr/td[1]/div/div");
	By sismapstudentbtn = By.xpath("//span[text()='Map Students']/ancestor::a");
	...
	By stusrcassessmentreport = By.xpath("//span[contains(text(),'"+GlobalVariable.studentName+"')]/preceding-sibling::img/following-sibling::input");
	...
	By academylocsearch = By.xpath("//input[@name='academyLocation']");
	By screennamesearch = By.xpath("//input[@name='screenName']");
	By optionalfield = By.xpath("//div[text()='Mandatory' and contains(@class,'cell')]/parent::td");
	By optionalfielddropdown = By.xpath("//input[@name='fieldMandatory']/../../td[2]");
	By visiblefield = By.xpath("//div[text()='Yes' and contains(@class,'cell')]/parent::td");
	By visiblefielddropdown = By.xpath("//input[@name='fieldVisibility']/../../td[2]");
	By screenmode = By.xpath("//div[@data-xpath='configurescreengrid_gridview']//div[text()='Create Edit View' and contains(@class,'cell')]/..");
	By completionstatus = By.xpath("//input[@name='status' and @readonly='readonly']");
	By academictermcheck = By.xpath("//input[@name='academicTerm']");
	By labelnamefield = By.xpath("//div[text()='Yes' and contains(@class,'cell')]/parent::td/following-sibling::td[1]");
	By labelfieldnametext = By.xpath("//input[@name='newLableName']");
	
	By sectiongroupdropdown = By.xpath("//input[@name='sectionId' and contains(@class,'focus')]/../../td[2]");	
...
//		Thread.sleep(2000);
	...
	public void iEnterNameWeightageMinandMaxMarks(String name, String weightage, String minmarks, String maxmarks) throws Exception {
		...
		try {
			...
			System.out.println("  Input Text field element is not clickable.");
		}
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(sisstatusdiv, "Selecting the Exam Status in the list");
		Thread.sleep(2000);
		new CommonLocatorPage().iClickSaveButton("normal");
		Thread.sleep(2000);
		new CommonLocatorPage().iClickYes();
	...
	public void iClickPendingEnrolledStudentLink() throws Exception {
		...
		String webelevalue = null;
		String driverelevalue = null;	
		Thread.sleep(2000);
		String ele = driver.findElement(sispendingstuenrldiv).getText().trim();
		
		String eleexam = CommonActions.iGetTextByLoctor(sispendingstuenrldiv, ele);
		System.out.println("Enrolled Student data size : "+ele);
		System.out.println("Enrolled Student data size : "+eleexam);		
		
		if(ele.equalsIgnoreCase("Pending") || eleexam.equalsIgnoreCase("Pending")) {
		CommonActions.iClickElementByLocator(sispendingstuenrldiv, "Selecting the Pending link in the list");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(siselgbletxtbox , "Selecting student enrolment mapping btn");
		Thread.sleep(1000);
		CommonActions.iClickElementByLocator(sismapstudentbtn , "Clicking Map Student button");
		Thread.sleep(2000);
		new CommonLocatorPage().iClickYes();
		Thread.sleep(2000);
		}
		else if(ele.equalsIgnoreCase("1") || eleexam.equalsIgnoreCase("1")) {
			CommonActions.iClickElementByLocator(sispendingstuenrldiv, "Selecting the Pending link in the list");
			Thread.sleep(2000);
		}
		try {
			String elevalue = driver.findElement(noofstuvalue).getText().trim();
			driverelevalue=elevalue;
		} catch (Exception e) {
			WebElement examele =CommonActions.getElement(noofstuvalue);
			String value = examele.getText().trim();
			webelevalue=value;
		}		
		
		System.out.println("Total No of Mapped Students Value Before  : "+webelevalue);		
		System.out.println("Total No of Mapped Students Value After  : "+driverelevalue);
		
		if(webelevalue.equalsIgnoreCase("1") || driverelevalue.equalsIgnoreCase("1")) {
	...
	public void iSelectAcdLocandTemplateFormatType(String temformattype) throws Exception{
		...
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(By.xpath("//div[contains(text(),'"+temformattype+"')]"), "Selecting the Tempalte format Value");
	}
	...
	public void iAddPbsSectionforSIS(String homeroom, String teachername) throws Exception {
		...
		BaseClass.writeInFile("Examination New Section Name ", PBSSectionNameSIS);
	...
	public void iSelectUnallocatedStuandAssignSec() throws Exception {
		...
		Thread.sleep(3000);
		CommonActions.iClickElementByLocator(sectiongroupdropdown, "Selecting the assign section group dropdown");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(By.xpath("//div[contains(text(),'"+GlobalVariable.PBSSectionNameSIS+"') and contains(@class,'item')]"), "Selecting Section Name");
		Thread.sleep(2000);
		new CommonLocatorPage().iClickSaveButton("window");
	}
...
//			CommonActions.iClickElementByLocator(currentandpublishdate , "Selecting the Published Date");
	...
	public void iSearchAssessmentSchemeByName(String type, String acadterm , String newname) throws Exception {
		CommonActions.iClickElementByLocator(By.xpath("//input[@name='evaluationplantype']/../../td[2]"),
				"clicking Assessment Scheme type dropdown");
		CommonActions.iClickElementByLocator(By.xpath("//div[text()=' " + type + " ']"),
				"Selecting Assessment scheme type");
...
//		CommonActions.iClickEnter(assessschtxt);
		...
		String schemename = GlobalVariable.AssessmentSchemeName;
		String name = schemename.replace("Assessment Scheme", "").trim();
		...
		try {
			...
			CommonActions.clickOnElementAndType(By.cssSelector("input[name='evaluationplanno']"), name,	"Selecting Assessment Scheme Name");
			...
			System.out.println("Inside the Catch block");
			WebElement ele = CommonActions
					.getElement(By.xpath("//div[text()=' " + schemename + " ']"));
			CommonActions.iClickJSE(ele, "Selecting the value using webelement");
		}
	...
	public void iSelectAssessmentSchemeName(String name) throws Exception {
		...
		String schemename = GlobalVariable.AssessmentSchemeName;
		String newname = schemename.replace("Assessment Scheme", "").trim();

		try {
			CommonActions.iClickElementByLocator(By.xpath("//div[contains(text(),'"+newname+"')]/ancestor::tr"),
					"Selecting Assessment Scheme Name in the List");
		} catch (Exception e) {

			System.out.println("Inside the Catch block");

			WebElement ele = CommonActions.getElement(By.xpath("//div[contains(text(),'"+newname+"')]/ancestor::tr"));
	...
	public void iSelectAcademyLocationandScreenName(String screenname) throws Exception {
		CommonActions.clickOnElementAndType(academylocsearch, GlobalVariable.academyLocation, "Finding the Academy Location");
		Thread.sleep(2000);
		CommonActions.iClickEnter(academylocsearch);
		CommonActions.clickOnElementAndType(screennamesearch, screenname, "Finding the Screen Name");
		Thread.sleep(2000);
		CommonActions.iClickEnter(screennamesearch);
		
	}

	public void iSelectAssessmentBasicDetailsRow() throws Exception {
		CommonActions.iClickElementByLocator(By.xpath("//div[text()='"+GlobalVariable.academyLocation+"']/ancestor::tr"), "Selecting the search result row");
		
	}

	public void iSelectAssessmentBasicScreenAndChangeVisibilityandOption(String visibility, String option) throws Exception {
		CommonActions.iClickElementByLocator(optionalfield, "Selecting the Optional Field ");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(optionalfielddropdown, "Selecting the Optional Field value dropdown ");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(By.xpath("//div[text()=' "+option+" ' and contains(@class,'item')]"), "Selecting the Optional Field Value ");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(visiblefield, "Selecting the Optional Field ");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(visiblefielddropdown, "Selecting the Optional Field value dropdown ");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(By.xpath("//div[text()=' "+visibility+" ' and contains(@class,'item')]"), "Selecting the Visibility Field Value ");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(screenmode, "Selecting the Screen mode Field");
		new CommonLocatorPage().iClickSaveButton("normal");
				
	}

	public void iValidateNoAcademicTermVisibleinBasicDetails() throws Exception {
		CommonActions.iClickElementByLocator(completionstatus, "Selecting the Complition statuus textfield ");
		new CommonLocatorPage().iClickSaveButton("nested");		
	}

	public void iValidateYesAcademicTermVisibleinBasicDetails() throws Exception {
		CommonActions.iClickElementByLocator(academictermcheck, "Selecting the Academic Term textfield ");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(completionstatus, "Selecting the Complition statuus textfield ");
		new CommonLocatorPage().iClickSaveButton("nested");		
	...
	public void iAbletoChangeAcademicTermLabelName(String labelname) throws Exception {
		CommonActions.iClickElementByLocator(labelnamefield, "Selecting the New Label Name Field ");
		Thread.sleep(2000);
		CommonActions.clickOnElementAndType(labelfieldnametext, labelname, "Enter the New Label Name");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(screenmode, "Selecting the Screen mode Field");
		new CommonLocatorPage().iClickSaveButton("normal");
	}

	public void iValidateAcademicTermFieldName() throws Exception {
		CommonActions.iClickElementByLocator(screenmode, "Selecting the Screen mode Field");
		new CommonLocatorPage().iClickSaveButton("normal");	
	}
