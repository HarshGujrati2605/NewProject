	 ...
	 public void iEnterMarksintotheValues()throws Exception {
	  ...
	  public void iClickEnterRemarksButton()throws Exception {
	   ...
	   public void iEntertheRemarks() throws Exception {
	    ...
	    @And("I select academy location and {string}")
		public void iSelectAcademyLocationandScreenName(String screenname)throws Exception {
			new ExaminationPages().iSelectAcademyLocationandScreenName(screenname);
		}
	    
	    @And("I select the assessment basic detail screen row")
		public void iSelectAssessmentBasicDetailsRow()throws Exception {
			new ExaminationPages().iSelectAssessmentBasicDetailsRow();
		}
	    
	    @Then("I select assessment basic screen and change visiblity to {string} and {string}")
		public void iSelectAssessmentBasicScreenAndChangeVisibilityandOption(String visibility, String option)throws Exception {
			new ExaminationPages().iSelectAssessmentBasicScreenAndChangeVisibilityandOption(visibility, option);
		}
		...
		public void iValidateNoAcademicTermVisibleinBasicDetails()throws Exception {
			new ExaminationPages().iValidateNoAcademicTermVisibleinBasicDetails();
		}
		...
		public void iValidateYesAcademicTermVisibleinBasicDetails()throws Exception {
			new ExaminationPages().iValidateYesAcademicTermVisibleinBasicDetails();
		}
	    
	    @Then("I can able to change academic term {string} in new label name field")
		public void iAbletoChangeAcademicTermLabelName(String labelname)throws Exception {
			new ExaminationPages().iAbletoChangeAcademicTermLabelName(labelname);
		}
	    @Then("I validate academic term field name is changed")
		public void iValidateAcademicTermFieldName()throws Exception {
			new ExaminationPages().iValidateAcademicTermFieldName();
		}
