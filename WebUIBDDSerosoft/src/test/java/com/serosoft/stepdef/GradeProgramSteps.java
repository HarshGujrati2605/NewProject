...
public class GradeProgramSteps {
	...
	@And("I add program or grade batch details with {string},{string},{string},{string},{string}")
	public void iAddingProgramBatchforGradeDetails(String gradeperoidtype, String intakeyear, String assigncalender, String calculation, String sgpacgparule)
			throws Exception {
		new GradeProgramPage().iAddingProgramBatchforGradeDetails(gradeperoidtype, intakeyear, assigncalender, calculation, sgpacgparule);
	}
	...
	@And("I fill the mandatory details for course or subject with grade of {string},{string},{string},{string},{string}")
	public void iAddCourseOrSubject(String type, String department, String minmarks, String maxmarks , String coursetype) throws Exception {
		new GradeProgramPage().AddCourseOrSubjectwithGrade(type, department, minmarks, maxmarks, coursetype);
	}
	...
	@And("I fill the mandatory details for course or subject of {string},{string},{string},{string},{string} for creating {string}")
	public void iAddCourseOrSubjectwithgrade(String type, String department, String mingrade, String maxgrade , String coursetype , String numberofcurses) throws Exception {
		new GradeProgramPage().AddCourseOrSubjectMultiple(type, department, mingrade, maxgrade, coursetype, numberofcurses);
	}
	

	@And("I Fill the course details with {string}")
	public void iClickonCreateCourses(String subjectname) throws Exception {
		new GradeProgramPage().iAddMultipleSubjectsinProgram();
	}
	
	@Given("I select the courses")
	public void selectSubjects() throws Exception {
		new GradeProgramPage().selectMultipleCOurses();
	}
	
	@Then("I map the multiple subject with period")
	public void iClickedOnMapPeriodForMultipleSubjects() throws Exception {
		new GradeProgramPage().iClickMapPeriodButtonAndMappedForMultipleSubjetcs();

	}
	
	@And("I Click on add class and AssignCalender fill details for multiple subjects")
	public void iClickonAssignCalenderandSearchForMultipleSubjects() throws Exception {
		new GradeProgramPage().iAddClassDeatilsForMultipleSubjects();
	}
	
	@And("I Click on map grade period for multiple courses")
	public void iClickMapGradePeriodForMultipleSubject() throws Exception {
		new GradeProgramPage().iClickonMapGradePeriodForMultiplecourses();
	}
	@And("I click on add and select multiple subjects {string}")
	public void iAddsubjectParameterformultiplesubjects(String teacher) throws Exception {
		new GradeProgramPage().iAddsubjectParameterandaddclassteacher(teacher);
	}
