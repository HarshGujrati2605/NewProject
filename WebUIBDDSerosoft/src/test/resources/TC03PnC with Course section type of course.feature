...
Feature: PnC Scenarios
  ...
  Scenario Outline: Add Grade/Program details
    ...
    Examples: 
      ...
      | Programs   | Programs & Courses | Add    | Manually   | Under Graduate | BTech    | Marks     | Academic Affairs | DXT-Dehradun | 10001111 |
  ...
  Scenario Outline: Create Prg or Grade intake details
    ...
    Examples: 
      ...
      | Yearly          |       2023 | demo calendar    | Current Period CGPA and SGPA | Add    |
  ...
  Scenario Outline: Manage subjects class or course section creation
    ...
    Examples: 
     ...
     # | Manage Subject Class  | Grades & Subjects  | Crawford Lonehill College Cal |         2023 | Marks            |
      | Manage Course Section | Programs & Courses | demo calendar                  |         2023 | Marks            |
